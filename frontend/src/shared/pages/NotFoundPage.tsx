...
export const NotFoundPage = () => (
  <section className="rounded-md border border-brand-border bg-brand-surface p-8 shadow-app-card">
    ...
    <div className="mt-6">
      <Link
        className="inline-flex min-h-10 items-center justify-center rounded-md bg-brand-primary px-4 text-sm font-semibold text-white transition hover:bg-brand-primary-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary"
        to="/home"
      >
        Return home
      </Link>
