        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_learning_outcomes_households_household_id",
                        column: x => x.household_id,
                        principalTable: "households",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_learning_outcomes_household_id_category_sort_order",
                table: "learning_outcomes",
                columns: new[] { "household_id", "category", "sort_order" });

            migrationBuilder.CreateIndex(
                name: "ix_learning_outcomes_household_id_code",
                table: "learning_outcomes",
