...
namespace EarlyLearner.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260723120505_InitialCreate")]
            ...
            modelBuilder.Entity("EarlyLearner.Domain.LearningContext.Entities.LearningOutcome", b =>
                {
                    ...
                    b.HasIndex("HouseholdId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_learning_outcomes_household_id_code");

                    b.HasIndex("HouseholdId", "Category", "SortOrder")
                        .HasDatabaseName("ix_learning_outcomes_household_id_category_sort_order");
            ...
            modelBuilder.Entity("EarlyLearner.Domain.LearningContext.Entities.LearningOutcome", b =>
                {
                    b.HasOne("EarlyLearner.Domain.IdentityContext.Entities.Household", "Household")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_learning_outcomes_households_household_id");
