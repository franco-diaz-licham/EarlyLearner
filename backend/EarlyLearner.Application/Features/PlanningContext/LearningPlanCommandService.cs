...
public interface ILearningPlanCommandService
{
    ...
    Task<Result> DeleteAsync(Guid learningPlanId, CancellationToken cancellationToken);
}
...
public interface ILearningPlanCommandRepository
{
    ...
    Task<LearningPlan?> GetAsync(Guid learningPlanId, CancellationToken cancellationToken);
...
public sealed class LearningPlanCommandService(ILearningPlanCommandRepository learningPlanRepo, IUnitOfWork uow) : ILearningPlanCommandService
{
    public async Task<Result<LearningPlanResponse>> CreateAsync(CreateLearningPlanCommand command, CancellationToken cancellationToken)
    {
        ...
        var result = await learningPlanRepo.GetResponseAsync(plan.Id.Value, cancellationToken);
    ...
    public async Task<Result> DeleteAsync(Guid learningPlanId, CancellationToken cancellationToken)
    {
